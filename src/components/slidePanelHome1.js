...
<div className="shout" style={{position:'absolute', top:'10vh',}}>
  ...
  <div className="outerpanel" style={{borderLeft:'none', height:'100vh'}}>
  <Image className="bgimg" alt="Temp Graphic" filename="night316-panel.jpg" />
  {/* <img src="https://source.unsplash.com/random/1200x12002" alt="rando" /> */}
<span className="headline grad">Popular Favorites</span>
      <div className="innerpanel" style={{}}>
      
          <div className="contentpanel" style={{}}>
          
          
          <strong style={{}}>Popular Favorites</strong><br />
          <p style={{ }}>This is a collection of both the most popular images as well as some of Todd's personal favorites. </p>
        
        <p style={{}}>If you're new to the work of Todd Lambert, this is a good place to start.</p>
        <h1 style={{fontSize:'100%', animation: 'fade 3s forwards', opacity:'0', textAlign:'center', maxWidth:'50%', margin:'0 auto'}}><Link className="button2" to="/galleries/favorites/">Get Started Now! </Link></h1>
 ...
 <span className="headline grad">Marketing</span>
      <div className="innerpanel" style={{}}>
...
<span className="headline grad">Consulting</span>
      <div className="innerpanel" style={{}}>
...
<span className="headline grad">Media</span>
      <div className="innerpanel" style={{}}>
